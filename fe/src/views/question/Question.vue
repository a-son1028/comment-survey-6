  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div>
          <div class="mt-4"> <b>Question: </b> </div>
         
          <div>
            
            <ol>
              <li>Is the app's description mentioning its personal data collection and sharing behaviors?
              ...
              <li v-if="dataCollections.length">How would you rate the necessary level of the app's personal data collection?
                <div>
                  <ol type="a">
                    <!--  -->
                    <li
                      v-for="(dataCollection, index) in dataCollections"
                      :key="index"
                    > 
                      ...
                      <div v-if="dataCollection.purposes.length">
                        <ol type="i">
                          <li
                            v-for="(dataType, index2) in dataCollection.purposes"
                            :key="index2"
                          >
                            {{ dataType.title }} {{ questions.question2[dataType.key].value }}
                            <div>
                              <UIRadioGroup
                        ...
                        <ol type="i">
                          ...
                          >
                            ...
                            >
                              <ol>
                                <li 
                                  v-for="(purpose, index3) in dataType.purposes"
                                  :key="index3"
                                >
                                  {{ purpose.title }}
                                  <UIRadioGroup
              ...
              <li v-if="dataShared.length">How would you rate the necessary level of the app's personal data sharing?
                <div>
                  <ol type="a">
                    <!--  -->
                    <li
                      v-for="(dataSharing, index) in dataShared"
                      :key="index"
                    > 
                      {{ dataSharing.title }}
                      <div v-if="dataSharing.purposes.length">
                        <ol type="i">
                          <li
                            v-for="(dataType, index2) in dataSharing.purposes"
                            :key="index2"
                          >
                            {{ dataType.title }}
                            <div>
...
export default {
  ...
  watch: {
    ...
    answer(answer) {
      if(!answer.survey) this.$router.push('/survey')
    }
  },
  mounted() {
    Promise.all([
